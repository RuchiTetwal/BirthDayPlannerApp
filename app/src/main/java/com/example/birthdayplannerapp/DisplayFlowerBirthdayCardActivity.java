...
public class DisplayFlowerBirthdayCardActivity extends AppCompatActivity {
    ...
    private void  save(Bitmap bitmap){
        ...
        String fileName = "flower_birthday_card"+ System.currentTimeMillis() +".jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_flower_birthday_card);

        getSupportActionBar().setTitle("Birthday Card");

        tv = findViewById(R.id.userReceivedName);
        cardLayout = findViewById(R.id.flowerCardLayout);
